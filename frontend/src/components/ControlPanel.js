  ...
  const handleSave = async () => {
    ...
    try {
      await axios.post(`${API}/configurations`, {
        name: saveName,
        radio: config.radio,
        driver_transistor: config.driverTransistor,
        driver_box_size: config.driverBoxSize,
        driver_heatsink: config.driverHeatsink,
        mid_driver_transistor: config.midDriverTransistor,
        mid_driver_box_size: config.midDriverBoxSize,
        mid_driver_heatsink: config.midDriverHeatsink,
        final_transistor: config.finalTransistor,
        final_box_size: config.finalBoxSize,
        final_heatsink: config.finalHeatsink,
