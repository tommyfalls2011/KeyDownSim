...
async def create_config(data: ConfigCreate, user: dict = Depends(get_current_user)):
    ...
    config_doc = {
        ...
        "driver_box_size": data.driver_box_size,
        "driver_heatsink": data.driver_heatsink,
        "mid_driver_transistor": data.mid_driver_transistor,
        "mid_driver_box_size": data.mid_driver_box_size,
        "mid_driver_heatsink": data.mid_driver_heatsink,
        "final_transistor": data.final_transistor,
        "final_box_size": data.final_box_size,
        "final_heatsink": data.final_heatsink,
